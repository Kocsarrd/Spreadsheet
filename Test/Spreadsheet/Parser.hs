...
testsFor = [ ("=12", For (Formula "=12" (Left FNoCache) (Just [Code "12"])))
           ...
           , ("  =§a0§", For (Formula "  =§a0§" (Left FNoCache) (Just [Refs [(0, Relative,Relative)]])))
           , (" = sumD §a0:A2§", For (Formula " = sumD §a0:A2§" (Left FNoCache) (Just [Code "sumD ", Refs [(0, Relative,Relative),(2, Relative,Relative),(5, Relative,Relative)]])))
           , ("=§A0§+ §b0§", For (Formula "=§A0§+ §b0§" (Left FNoCache) (Just [Refs [(0, Relative,Relative)], Code "+ ", Refs [(1, Relative,Relative)]])))
           , ("=3 + sqrt §a0§ + 4.23 * productD §B0:B2§ ", For (Formula "=3 + sqrt §a0§ + 4.23 * productD §B0:B2§ "
                                                               (Left FNoCache) (Just [Code "3 + sqrt "
                                                                                     , Refs [(0, Relative,Relative)]
                                                                                     , Code " + 4.23 * productD "
                                                                                     , Refs [(1, Relative,Relative),(3, Relative,Relative),(7, Relative,Relative)]
                                                                                     , Code " "])))]
